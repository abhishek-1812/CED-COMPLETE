...
$(document).ready(function(){
    ...
    $.ajax({
                ...
                for(var i=0;i<data.length;i++) { 
                    output+= "<tr><td>" + data[i]['lid'] + "</td><td>" + data[i]['name'] + "</td><td>" + data[i]['distance'] + "</td><td>" + data[i]['isavail'] + "</td><td><input type='submit' class='btn btn-danger' value='DELETE' id='delbtn' data-did=" + data[i]['lid'] + "></td></tr>";                        
                }
                $('#data').html(output); 
                }               
            });
