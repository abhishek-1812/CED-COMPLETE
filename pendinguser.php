...
<body class="id">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <section>
    <select name="" id="sort_app" class="sort">
            <option value="">SORT BY</option>
            <option value="date">DATE</option>
        </select>
        <h2 class="text-center mt-4">PENDING USERS</h2>
...
$(document).ready(function(){
    ...
    $.ajax({
                ...
                for(var i=0;i<data.length;i++) { 
                    output+= "<tr><td>" + data[i]['userid'] + "</td><td>" + data[i]['username'] + "</td><td>" + data[i]['name'] + "</td><td>" + data[i]['date'] + "</td><td>" + data[i]['mobile'] + "</td><td><input type='submit' class='btn btn-secondary mr-2' id='edit-btn' value='APPROVE' data-eid="+ data[i]['userid'] + "><input type='submit' class='btn btn-danger' value='DELETE' id='delbtn' data-did=" + data[i]['userid'] + "></td></tr>";                        
                }
                $('#data').html(output); 
                }               
            });
       ...
       $(document).on("click",'#edit-btn', function(){
            ...
            var element=this;
            var action ='del_btn_for_app_users';
            $.ajax({
                url : 'ajaxaction.php',
                type : "POST",
                data : {id:id, action:action},
